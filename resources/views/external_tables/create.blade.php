...
<div class="row">
    <div class="col-12">
        <form class="pt-4" action="/data_elements" method="post" id="form">
            @csrf
            ...
            @if ($data['role_name'] == 'admin')
                <div class="form-group">
                    ...
                    <div class="btn-group">
                        <button id="external_system" type="button" class="btn btn-primary">None</button>
            ...
            <input type='hidden' id="creator_id" name='creator_id' value='{{$data['user_id']}}'/>
